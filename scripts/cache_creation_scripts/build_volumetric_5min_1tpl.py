"""
Build 5-minute volumetric bar cache at 1-tick-per-level resolution.

Long-format Parquet, one row per (session_date, bar_open_time, level_price).
...
Output: D:/trading_pythonbacktest_data/volumetric_5min_1tpl.parquet
"""
import sys
import time
import zipfile
...
OUTPUT = DATA_DIR / "volumetric_5min_1tpl.parquet"
...
SHARD_DIR = DATA_DIR / "_tmp_volumetric_5min_shards"
